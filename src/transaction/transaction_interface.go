...
type TransactionRepository interface {
	...
	RetrieveAllTransaction(page, size int, companyId string) ([]entity.Transaction, int, error)
...
type TransactionUsecase interface {
	...
	GetAllTransaction(page, size int, companyId string) ([]transaction.ResponseTransaction, int, error)
